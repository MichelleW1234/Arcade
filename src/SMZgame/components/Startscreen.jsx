        ...
        <div className = "StartingScreenLayout">
            ...
            <div className = "header-glow-box">
                ...
                <h1 className = "headerwords">
                    Loading <span className = "headerwordsGlitch">Sky Maze</span>...
                </h1>
            </div>
            ...
            <div className = "generalbuttonContainer">
                ...
                <Link to="/SMZinstructions" className = "generalbuttonGlitch Continue" onClick = {() => playSound(1)}>
                    Continue
                </Link>

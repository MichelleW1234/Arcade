        ...
        <div className = "StartingScreenLayout">
            ...
            <div className = "header-glow-box">
                ...
                <h1 className = "headerwords">
                    Loading <span className = "headerwordsGlitch">Balloon Frenzy</span>...
                </h1>
            </div>
            ...
            <div className = "generalbuttonContainer">
                ...
                <Link to="/BFRinstructions" className = "generalbuttonGlitch Continue" onClick = {() => playSound(1)}>

  ...
  const [ Prize, setPrize] = useState(() => {
    try {
      ...
      return Array.isArray(storedPrize) ? storedPrize : [["Bear", 80, Bear], ["BumbleBee", 50, Bee], ["Valentine", 20, Heart],
                                                          ["GameBoy", 100, GameBoy], ["Robot", 30, Robot], ["Alien", 20, Alien], ["Spider", 80, Spider]]; // Ensure it's an array
    } catch (error) {
      return [["Bear", 80, Bear], ["BumbleBee", 50, Bee], ["Valentine", 20, Heart],
      ["GameBoy", 100, GameBoy], ["Robot", 30, Robot], ["Alien", 20, Alien], ["Spider", 80, Spider]]; // Fallback if JSON parsing fails
    }
  });

        ...
        <div className = "StartingScreenLayout">
            ...
            <div className = "header-glow-box">
                ...
                <h1 className = "headerwords">
                    Loading <span className = "headerwordsGlitch"> Color Blast</span>...
                </h1>
            </div>
            ...
            <div className = "generalbuttonContainer">
                ...
                <Link to="/CBLinstructions" className = "generalbuttonGlitch Continue" onClick = {() => playSound(1)}>
                    Continue
                </Link>
